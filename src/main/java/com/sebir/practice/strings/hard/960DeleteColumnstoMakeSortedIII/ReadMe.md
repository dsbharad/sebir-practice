...
URL: https://leetcode.com/problems/delete-columns-to-make-sorted-iii/description/?envType=problem-list-v2&envId=string
...
_<u>Problem statement</u>_: Return the minimum possible value of answer.length.
