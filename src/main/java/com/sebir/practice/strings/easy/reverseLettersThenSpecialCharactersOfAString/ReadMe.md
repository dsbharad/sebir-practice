...
_<u>Problem statement</u>_: You are given a string s consisting of lowercase English letters and special characters.
...
**Constraints:**
    ...
    1. 1 <= s.length <= 100
    2. s consists only of lowercase English letters and the special characters in "!@#$%^&*()".